...
import { startAlarm } from 'natives';
...
export default class Fingerpointing{
    ...
    start()
    {
        if(!this.active)
        {
            ...
            this.requestAnimDicPromise("anim@mp_point").then(() => {
                ...
                game.taskMoveNetworkByName(this.localplayer.scriptID, "task_mp_point", 0.5, false, "anim@mp_point", 24);
                game.removeAnimDict("anim@mp_point");
                this.cleanStart = true;
                this.interval = alt.setInterval(this.porcess.bind(this), 0);
